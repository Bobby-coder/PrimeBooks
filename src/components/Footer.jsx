    ...
    <footer className="text-muted-foreground py-8 md:px-8 lg:px-10 border-t border-muted mx-auto">
      <div className="container mx-auto grid grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="space-y-2">
          ...
          <ul className="space-y-1">
            <li>
              <Link className="hover:underline">Fiction</Link>
            </li>
            <li>
              <Link className="hover:underline">Non-Fiction</Link>
            </li>
            <li>
              <Link className="hover:underline">Sci-Fi</Link>
            </li>
            <li>
      ...
      <div className="mt-8 text-center text-sm">
        &copy; 2024 PrimeBooks. All rights reserved.
      </div>
    </footer>
  );
}
